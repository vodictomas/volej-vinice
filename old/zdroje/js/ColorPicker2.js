...
function pickColor(color){
  ...
  //if(ColorPicker_targetInput2.type=="div")
...
cp_contents += "<tr><td>Hospa</td><td class='click'><a href='javascript:void(0);' id='href_img_1' onClick= \""+windowRef+"PicturePicker_pickPicture('1',"+obj_pom+")\"><img src='zdroje/icons/pivo3b.jpg' alt='Jo na jedno klidně zajdu.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Jo na jedno klidně zajdu.\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_9' onClick=\""+windowRef+"PicturePicker_pickPicture('9',"+obj_pom+")\"><img src='zdroje/icons/vino.png' alt='Du na víno.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Du na víno.\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_2' onClick=\""+windowRef+"PicturePicker_pickPicture('2',"+obj_pom+")\"><img src='zdroje/icons/kofola3r.jpg' alt='Du jen na kofolu.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Du jen na kofolu.\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_6' onClick=\""+windowRef+"PicturePicker_pickPicture('6',"+obj_pom+")\"><img src='zdroje/icons/moch2.jpg' alt='Jdu na \"houbu\".' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Já jdu houbařit (; .\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_3' onClick=\""+windowRef+"PicturePicker_pickPicture('3',"+obj_pom+")\"><img src='zdroje/icons/hranolky4.jpg' alt='A já si dám hranolky, dvojitý' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"A já si dám hranolky,dvojitý.\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_8' onClick=\""+windowRef+"PicturePicker_pickPicture('8',"+obj_pom+")\"><img src='zdroje/icons/invalidaSPivem3.jpg' alt='Sem zraněnej, ale na pivo mohu.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Sem zraněnej, ale na pivo mohu.\",window.document)'/></a></td>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_4' onClick=\""+windowRef+"PicturePicker_pickPicture('4',"+obj_pom+")\"><img src='zdroje/icons/dortik.jpg' alt='Slavíííím' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Slavíííím\",window.document)'/></a></td>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_5' onClick=\""+windowRef+"PicturePicker_pickPicture('5',"+obj_pom+")\"><img src='zdroje/icons/nonstop.jpg' alt='Pojďte do nonstopu! &copy; Bělka' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Pojďte do nonstopu! &copy; Bělka\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_7' onClick=\""+windowRef+"PicturePicker_pickPicture('7',"+obj_pom+")\"><img src='zdroje/icons/mochnon.gif' alt='Na houbu,pak do nonstopu.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Na houbu,pak do nonstopu.\",window.document)'/></a>";
cp_contents += "</td></tr>";
cp_contents += "<tr><td>Výmluva</td>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img_0' onClick=\""+windowRef+"PicturePicker_pickPicture('0',"+obj_pom+")\"><img src='zdroje/icons/postel2.jpg' alt='Musim jít brzo spát.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Musim jít brzo spát.\",window.document)'/></a>";
cp_contents += "</td><td class='click'><a href='javascript:void(0);' id='href_img_-2' onClick=\""+windowRef+"PicturePicker_pickPicture('-2',"+obj_pom+")\"><img src='zdroje/icons/kniha3.jpg' alt='Musim se učit.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Musim se učit.\",window.document)'/></a></td>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img_-3' onClick=\""+windowRef+"PicturePicker_pickPicture('-3',"+obj_pom+")\"><img src='zdroje/icons/ski2.jpg' alt='Sem na horách.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Sem na horách.\",window.document)'/></a></td>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img_-4' onClick=\""+windowRef+"PicturePicker_pickPicture('-4',"+obj_pom+")\"><img src='zdroje/icons/nemoc.jpg' alt='Sem nachcípanej, nebudu to dráždit.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Sem nachcípanej.\",window.document)'/></a></td>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img_-6' onClick=\""+windowRef+"PicturePicker_pickPicture('-6',"+obj_pom+")\"><img src='zdroje/icons/invalida3.png' alt='Sem zraněnej.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Sem zraněnej.\",window.document)'/></a></td>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img_-7' onClick=\""+windowRef+"PicturePicker_pickPicture('-7',"+obj_pom+")\"><img src='zdroje/icons/kocarek2.jpg' alt='Mateřske povinnosti.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Mateřske povinnosti.\",window.document)'/></a></td>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img_-8' onClick=\""+windowRef+"PicturePicker_pickPicture('-8',"+obj_pom+")\"><img src='zdroje/icons/prace3.png' alt='Musím být v práci.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Musím být v práci.\",window.document)'/></a></td>";
cp_contents += "<td>&nbsp;</td><td>&nbsp;</td></tr>";
cp_contents += "<tr><td>Uvidim</td><td class='click'><a href='javascript:void(0);' id='href_img_-1' onClick=\""+windowRef+"PicturePicker_pickPicture('-1',"+obj_pom+")\"><img src='zdroje/icons/otaznik2.jpg' alt='Uvidim až na místě.' onMouseOver='"+windowRef+"PicturePicker_highlightColor(\"Uvidim až na místě.\",window.document)'/></a></td>";
...
function PicturePicker2_select(date,person,linkname){
	console.log(date);console.log(ú)
  /*if(inputobj.type!="text" && inputobj.type!="hidden" && inputobj.type!="textarea" && inputobj2.type!="div"){
    alert("colorpicker.select: Input object passed is not a valid form input object");
    window.ColorPicker_targetInput=null;return;
  }*/
...
cp_contents += "<tr>";
cp_contents += "<td class='click'><a href='javascript:void(0);' id='href_img2_0' onClick=\""+windowRef+"PicturePicker2_pickPicture('0',"+obj_pom+")\"><img src=\"zdroje/icons/ft_disabled.gif\" /></a></td><td>Nemůžu</td>";
cp_contents += "<tr><td class='click'><a href='javascript:void(0);' id='href_img2_-1' onClick=\""+windowRef+"PicturePicker2_pickPicture('-1',"+obj_pom+")\"><img src=\"zdroje/icons/otaznik2.jpg\"/></a></td><td>Nevim</td></tr>";
